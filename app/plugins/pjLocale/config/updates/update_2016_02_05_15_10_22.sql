...
INSERT IGNORE INTO `plugin_locale_languages` (`id`, `iso`, `title`, `region`, `native`, `dir`, `country_abbr`, `language_abbr`, `file`) VALUES
...
UPDATE `plugin_locale` SET `language_iso` = 'ba-RU', `name` = 'Башҡорт (Россия)' WHERE `language_iso` = 'ba' LIMIT 1;
...
INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_lbl_dir', 'backend', 'Locale plugin / Text direction', 'plugin', '2016-02-05 10:14:28');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Text direction', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_lbl_fend', 'backend', 'Locale plugin / Front end', 'plugin', '2016-02-05 10:17:06');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Front end', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_dir_ARRAY_ltr', 'arrays', 'Locale plugin / Left to Right', 'plugin', '2016-02-05 10:54:19');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Left to Right', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_dir_ARRAY_rtl', 'arrays', 'Locale plugin / Right to Left', 'plugin', '2016-02-05 10:54:34');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Right to Left', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_flag_reset_title', 'backend', 'Locale plugin / Reset flag', 'plugin', '2016-02-05 14:24:57');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Reset flag', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_flag_reset_content', 'backend', 'Locale plugin / Reset flag: confirmation', 'plugin', '2016-02-05 14:25:26');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Are you sure you want to reset selected flag?', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_btn_reset', 'backend', 'Locale plugin / Button: Reset', 'plugin', '2016-02-05 14:27:33');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Reset', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_tooltip_upload', 'backend', 'Locale plugin / Upload tooltip', 'plugin', '2016-02-05 14:32:44');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Click to upload', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_tooltip_reset', 'backend', 'Locale plugin / Reset tooltip', 'plugin', '2016-02-05 14:32:59');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Click to reset', 'plugin');

INSERT IGNORE INTO `fields` VALUES (NULL, 'plugin_locale_lbl_language', 'backend', 'Locale plugin / Language', 'plugin', '2016-02-05 14:55:07');

SET @id := (SELECT LAST_INSERT_ID());

INSERT IGNORE INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Language', 'plugin');
