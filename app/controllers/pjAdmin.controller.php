...
class pjAdmin extends pjAppController
{
	...
	public function pjActionIndex()
	{
		...
		{
			pjUtil::redirect($_SERVER['PHP_SELF'] . "?controller=pjAdminSections&action=pjActionIndex");
		} else {
			$this->set('status', 2);
		}
	}
	...
	protected function setFilemanagerVars()
	{
		$dm = new pjDependencyManager(PJ_INSTALL_PATH, PJ_THIRD_PARTY_PATH);
		$dm->load(PJ_CONFIG_PATH . 'dependencies.php')->resolve();
		$this->set('filemanager_version', $dm->getVersion('filemanager'));
		$this->set('filemanager_path', $dm->getPath('filemanager'));
	}
}
?>