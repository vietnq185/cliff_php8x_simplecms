			...
			<p>
				...
				<span class="inline_block">
					<select name="section_id[]" id="section_id" class="pj-form-field w400" multiple="multiple" size="5">
						...
						{
							?><option value="<?php echo $v['id']; ?>"<?php echo in_array($v['id'], $tpl['section_ids_arr']) ? ' selected="selected"' : null;?>><?php echo stripslashes($v['section_name']); ?></option><?php
						}
						?>
					</select>
				</span>
			...
			<p>
				...
				<span class="inline_block">
					<select name="file_id[]" id="file_id" class="pj-form-field w400" multiple="multiple" size="5">
						...
						{
							?><option value="<?php echo $v['id']; ?>"<?php echo in_array($v['id'], $tpl['file_ids_arr']) ? ' selected="selected"' : null;?>><?php echo stripslashes($v['file_name']); ?></option><?php
						}
						?>
					</select>
				</span>
