<?php
$pj_config_path = dirname(__FILE__) . "/../../../../../app/config/";
$pj_filemanager_config = $pj_config_path . 'filemanager-top.inc.php';
...
$pj_filemanager_config = $pj_config_path . 'filemanager.inc.php';
if (is_file($pj_filemanager_config))
{
	include $pj_filemanager_config;
}
...
return array_merge(
	$config,
	array(
		'MaxSizeUpload' => ((int)(ini_get('post_max_size')) < $config['MaxSizeUpload']) ? $config['MaxSizeUpload'] : (int)(ini_get('post_max_size')),
		'ext'=> array_merge(
			$config['ext_img'],
			$config['ext_file'],
			$config['ext_misc'],
